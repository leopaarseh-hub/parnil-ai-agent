...
export const TRANSLATIONS: Record<SupportedLang, TranslationDict> = {
  de: {
    ...
    standardScaleOption: "Standard-Lieferung (10-15 Werktage)",
    accelerateOption: "Express-Lieferung (4-6 Werktage)",
  ...
  en: {
    ...
    standardScaleOption: "Standard Delivery (10 - 15 business days)",
    accelerateOption: "Accelerate Dispatch (4 - 6 business days)",
  ...
  tr: {
    ...
    standardScaleOption: "Standart Teslimat (10 - 15 iş günü)",
    accelerateOption: "Hızlandırılmış Gönderim (4 - 6 iş günü)",
  ...
  fa: {
    ...
    standardScaleOption: "تحویل استاندارد (۱۰ تا ۱۵ روز کاری)",
    accelerateOption: "لانچ سریع و پرشتاب (۴ تا ۶ روز کاری)",
